...
class camera_robot_calibration_ros():
    def __init__(self):
        ...
        self.base_frame_name=rospy.get_param('base_frame_name', 'base') #'/base'
        self.camera_frame_name=rospy.get_param('camera_frame_name', 'kinect2_link') #'/kinect2_1_rgb_optical_frame'
        self.robot_ee_frame_name=rospy.get_param('robot_ee_frame_name', 'right_gripper_base') #'/right_gripper_base'
        self.marker_frame_name=rospy.get_param('marker_frame_name', 'ar_marker_0') #'/ros_groovy'
